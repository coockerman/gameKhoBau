...
public class _HeapMapVisual : MonoBehaviour
{
    _Grid grid;
    Mesh mesh;
    ...
    public void SetGrid(_Grid grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, _Grid.OnGridValueChangedEventArgs e)
    {
        //UpdateHeatMapVisual();
        updateMesh = true;
